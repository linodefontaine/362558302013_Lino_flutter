        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Tombol verifikasi status yang disesuaikan untuk Autograding
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text('Status terverifikasi'),
                      ),
                    );
                  },
                  ...
                  child: const Text('Verifikasi Status'),
                ),
              ),
            ],
          ),
